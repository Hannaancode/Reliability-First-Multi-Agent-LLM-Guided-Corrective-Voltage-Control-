...
# Use 8 first for fair comparison with v0/v1.
MAX_ITERATIONS = 8

# Wider but still bounded reactive support search.
# Negative q_mvar = capacitive support in pandapower shunt convention.
Q_CANDIDATES_MVAR = [
